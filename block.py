...
a=commands.getstatusoutput("sudo lvcreate   --size "+size+"M  --name  " + name + "  myvg")
print a
if a[0]==0:
...
if ba[0]==0:
	...
	f.write("a=commands.getstatusoutput('iscsiadm --mode discoverydb --type sendtargets --portal 192.168.122.1 --discover') \n")
	f.write("b=commands.getstatusoutput('iscsiadm --mode node --targetname " + name + " --portal 192.168.122.1:3260 --login') \n")
	f.write("print a \n")
	f.write("print b \n")
	f.close()
